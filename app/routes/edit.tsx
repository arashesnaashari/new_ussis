            ...
            >
              {text?.message ? (
                ...
                <Button
                  ...
                  color={"#242e59"}
                >
                  تعداد ویس های بازبینی شده: {count}
                </Button>
              )}
                    ...
                    <AccordionItem border={"none"}>
                      ...
                      <AccordionPanel>
                        <Box lineHeight={"32px"}>
                          <p>
                            <span>
                              در این بخش در هر صفحه یک صوت و دو متن متناظر آن
                              برای شما نمایش داده می&zwnj;شود. هدف این است که
                              این دو متن هردو محتوای صوتی را نمایش دهند.&nbsp;
                            </span>
                          </p>
                          <p>&nbsp;</p>
                          <p>
                          ...
                          <p>
                            <span>
                              ...
                              این است که صوت&zwnj;ها از روی متن اول ادا شده و
                              لذا انتظار داریم که تفاوت&zwnj; بسیار کمی مشاهده
                              شود.
                            </span>
                          </p>
                          <p>&nbsp;</p>
                          ...
                          <p>
                            <span>
                              هدف متن دوم تبدیل صوت به متن با کاراکترهای فقط
                              فارسی است. چالش اصلی این است که بسیاری از عبارات
                              گفته شده در صوت&zwnj;ها حاوی کلمات انگلیسی و فارسی
                              هستند و هدف متن دوم این است که حتی کلمات انگلیسی
                              را فقط با کاراکترهای فارسی نمایش دهد. مثلا iphone
                              =&gt; آیفون، LED =&gt; ال ای دی، sportlight =&gt;
                              اسپورت لایت
                            </span>
                          </p>
                          <p>
                            <span>
                              ...
                              صورت&nbsp; آلترا یا اولترا تلفظ شود. در این حالت
                              ما به دنبال تلفظ درست یا استاندارد نیستیم و صرفا
                          ...
                          <ul>
                            <li>
                              <span>
                                در صورت عدم وجود صدای انسان در صوت پخش شده گزینه
                                "فایل صوتی نامشخص" را انتخاب کنید
                              </span>
                            </li>
                            <li>
                              <span>
                                در صورتی که صوت و دستور فرد از ابتدا یا انتها
                                ناقص است یا به نظر می آید که قبل از اتمام صحبت
                                گوینده ضبط صدا متوقف شده است&nbsp; گزینه "فایل
                        ...
                        <Box lineHeight={"32px"}>
                          ...
                          <p>
                            <span>
                              آیفون ۱۵ =&gt; آیفون پانزده/ آیفون پانزده
                            </span>
                          </p>
                          <p>
                            <span>
                              سامسونگ مدل A32 =&gt; سامسونگ مدل آ سی و دو
                            </span>
                          </p>
                          <ul>
                            <li>
                          ...
                          <ul>
                            <li>
                              <span>
                                در کلمات تنوین دار، تنوین به صورت الف ساده نوشته
                                شود.
                              </span>
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              <span>
                                ای نکره یا نسبت به صورت جدا نوشته شود&nbsp;
                              </span>
                            </li>
                          </ul>
                          <p>
                          ...
                          <ul>
                            <li>
                              <span>
                                در کلماتی مانند مدل دستگاه که چند حرف انگلیسی
                                پشت سر هم دارد، حروف با کاراکترهای فارسی و جدا
                                جدا نوشته شوند.
                              </span>
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              <span>
                                همزه یا ی که بعد از کلمات منتهی به ه، به عنوان
                                کسره اضافه می شود لازم نیست به هیچ صورتی مکتوب
                                شود.
                              </span>
                            </li>
                          </ul>
                          ...
                          <p>
                            <span>
                              (توجه: ی کسره اضافه شده در سایر کلمات، نوشته&nbsp;
                              می شود. مثلا کتابای من)
                            </span>
                          </p>
                          <ul>
                            <li>
                              <span>
                                تا جاییکه که امکانش هست و معنا بدهد کلمات دو
                                بخشی مرکب به صورت جدا نوشته شوند مثل:&nbsp;
                              </span>
                            </li>
                          </ul>
                          <p>
                          ...
                          <ul>
                            <li>
                              <span>
                                اعداد به صورت حروف و با املای درست نوشتاری نوشته
                                شوند :&nbsp;
                              </span>
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              <span>
                                در صورتیکه جمله یا عبارت شنیده شده ناقص است، اگر
                                آخرین کلمه تا حد خوبی ادا شده به طوری که برای
                                شما به عنوان کاربر انسانی قابل تشخیص است آن را
                                بنویسید، وگرنه تا همانجا که قابل تشخیص است نوشته
                                شود.
                              </span>
                            </li>
                          </ul>
                          ...
                          <p>
                            <span>
                              هر جا شک داشتید، عبارت مورد نظر را در
                              سرچ&zwnj;باکس دیجی کالا جستجو کنید و نوشتار را
                              منطبق با نتیجه&zwnj;های نمایش داده شده انجام دهید
                              (کماکان با این شرط که فقط از حروف فارسی استفاده
                              می&zwnj;کنیم)
                            </span>
                          </p>
                        </Box>
