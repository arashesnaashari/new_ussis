    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            یوسسیسنت که از متنوع ترین مجموعه صدا یوسسیسنت که از متنوع ترین
            مجموعه صداها در جهان آموزش دیده است، ها در جهان آموزش دیده است،
            استاندارد دقت را برای برنامه های ویدیویی و صوتی تعیین می کند.
          </Text>
          <Box>
            {/* <a href="#test"> */}
            <Button
